...
public static class AnimatorHash
{
    ...
    public static class Float
    {
        ...
        public static readonly int PLAYER_MOVE_DIRECTION_X = Animator.StringToHash("MoveDirectionX");
        public static readonly int PLAYER_MOVE_DIRECTION_Z = Animator.StringToHash("MoveDirectionZ");
